...
def _checks(module) -> dict[str, dict[str, Any]]:
    ...
    if jwt_source == "environment":
        persistence_detail = "Permanent Render JWT_SECRET configured"
    elif jwt_source == "database":
        persistence_detail = "Persistent Mongo-backed JWT signing key active"
    else:
        persistence_detail = "A secure runtime secret is active, but it is not restart-persistent"
