...
function launchPayload(overrides = {}) {
  const base = {
    ...
    billing: {
      ...
      verified_paid_users: [{ id: 'paid-1', email: 'paid@real.test', business_name: 'Real Paid Business', plan: 'team', subscription_status: 'active', stripe_subscription_id: 'sub_paid', last_active: '2026-07-12T00:50:00+00:00' }],
      verified_trial_users: [{ id: 'trial-1', email: 'trial@real.test', business_name: 'Real Trial Business', plan: 'pro', subscription_status: 'trialing', stripe_subscription_id: 'sub_trial', last_active: '2026-07-11T22:00:00+00:00' }],
      tester_users: [{ id: 'tester-1', email: 'tester@real.test', display_email: 'Tester@Real.test', business_name: 'Real Tester Business', plan: 'pro', subscription_status: 'pending_signup', status: 'pending_signup', source: 'billing report', last_active: '2026-07-11T20:00:00+00:00' }],
      needs_verification: [{ id: 'verify-1', email: 'verify@real.test', business_name: 'Needs Verification Ltd', plan: 'solo', subscription_status: 'active', stripe_subscription_id: '', last_active: '2026-07-11T19:00:00+00:00' }],
      stripe: { configured: true, available: true, source: 'stripe_subscription_api', subscriptions_checked: 2, errors: [] },
    },
    collections: {
      connected: true,
      ...
      latest: { stripe_webhook: { created_at: '2026-07-12T00:40:00+00:00' }, support_message: { created_at: '2026-07-11T21:00:00+00:00' }, lifecycle_email: { created_at: '2026-07-11T20:00:00+00:00' } },
    },
    launch_checks: [
  ...
  await page.route('**/api/**', async (route) => {
    ...
    if (pathname === '/api/admin/owner-overview') return route.fulfill(json({
      ...
      lists: {
        ...
        events: [{ id: 'event-1', title: 'Real user signed in', kind: 'user', meta: 'live activity', at: '2026-07-12T00:30:00+00:00' }],
      },
    }));
    ...
    if (pathname === '/api/admin/owner/plan-report') return route.fulfill(json({ success: true, paid_count: 1, free_testers: [tester] }));
    if (pathname === '/api/admin/owner/control-log') return route.fulfill(json({ success: true, items: [{ id: 'control-1', title: 'Real access update', action: 'grant', created_at: '2026-07-12T00:20:00+00:00' }] }));
    ...
    if (pathname === '/api/admin/owner/testers') return route.fulfill(json({ success: true, counts: { total: 1, accepted: 0, active: 0, invited_not_accepted: 1 }, testers: [tester], invited_testers: [tester], accepted_testers: [], active_testers: [] }));
