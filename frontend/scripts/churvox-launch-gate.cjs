...
async function main() {
  ...
  if (enabled(env.CHURVOX_E2E_SIGNUP)) {
    steps.push(playwright('Real signup, Stripe and verification-email audit', ['tests/e2e/churvox-signup-to-stripe.spec.js', 'tests/e2e/churvox-email-verification-proof.spec.js']));
  } else {
