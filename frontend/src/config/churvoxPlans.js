...
export const ACCOUNTING_SYNC_ADDON = { key: "xero_addon", code: "xero_addon", name: "Accounting Sync Add-on", tag: "Accounting Sync", price: 39, monthly: 39, period: "month", interval: "month", description: "Optional Xero draft invoice sync where available. Included with Command. Owner approval required." };
