...
function App() {
  ...
  return <BrowserRouter><AuthProvider><ErrorBoundary><Toaster position="top-right" richColors /><ChurvoxHelpWidget /><Routes>
    ...
    <Route path="/dashboard" element={<BusinessRoute><FreshApp /></BusinessRoute>} /><Route path="/legacy/dashboard" element={<BusinessRoute><CommandDeskRoute fallbackHref="/dashboard" fallbackLabel="Back to Fresh Dashboard" /></BusinessRoute>} /><Route path="/overview" element={<Navigate to="/dashboard" replace />} />
    ...
    <Route path="/plans" element={<BusinessRoute><FreshApp /></BusinessRoute>} /><Route path="/billing" element={<OwnerRoute><BillingReturnPage /></OwnerRoute>} /><Route path="/billing/success" element={<OwnerRoute><BillingReturnPage /></OwnerRoute>} /><Route path="/billing/cancel" element={<OwnerRoute><BillingReturnPage cancelled /></OwnerRoute>} />
