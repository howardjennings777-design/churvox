...
function App() {
  ...
  return <BrowserRouter><AuthProvider><ErrorBoundary><Toaster position="top-right" richColors /><ChurvoxHelpWidget /><Routes>
    ...
    <Route path="/login" element={<PublicRoute><LoginPage /></PublicRoute>} /><Route path="/signup" element={<SignupPage />} /><Route path="/register" element={<Navigate to="/signup" replace />} /><Route path="/forgot-password" element={<PublicRoute><ForgotPasswordPage /></PublicRoute>} /><Route path="/reset-password" element={<PublicRoute><ResetPasswordPage /></PublicRoute>} /><Route path="/invite/setup/:token" element={<InviteSetupPage />} />
    ...
    <Route path="/onboarding" element={<BusinessRoute><OnboardingCommandPage /></BusinessRoute>} /><Route path="/jobs-board" element={<Navigate to="/dashboard#jobs" replace />} /><Route path="/jobs" element={<Navigate to="/jobs-board" replace />} /><Route path="/jobs/new" element={<BusinessRoute><JobFormPage /></BusinessRoute>} /><Route path="/jobs/:id" element={<BusinessRoute><JobDetailPage /></BusinessRoute>} /><Route path="/jobs/:id/edit" element={<BusinessRoute><JobFormPage /></BusinessRoute>} />
    ...
    <Route path="/plans" element={<FreshBusinessRoute><FreshApp /></FreshBusinessRoute>} /><Route path="/billing" element={<OwnerRoute><BillingReturnPage /></OwnerRoute>} /><Route path="/billing/success" element={<OwnerRoute><BillingReturnPage /></OwnerRoute>} /><Route path="/billing/cancel" element={<OwnerRoute><BillingReturnPage cancelled /></OwnerRoute>} />
