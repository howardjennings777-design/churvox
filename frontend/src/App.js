...
function App() {
  ...
  return <BrowserRouter><AuthProvider><ErrorBoundary><Toaster position="top-right" richColors /><ChurvoxHelpWidget /><HQPlanMixFloating /><Routes>
    <Route path="/guide" element={<FreshBusinessRoute><FreshApp /></FreshBusinessRoute>} /><Route path="/setup" element={<FreshBusinessRoute><FreshApp /></FreshBusinessRoute>} /><Route path="/setup-guide" element={<FreshBusinessRoute><FreshApp /></FreshBusinessRoute>} /><Route path="/operator-tools" element={<Navigate to="/dashboard" replace />} /><Route path="/command-board" element={<Navigate to="/dashboard#command" replace />} /><Route path="/cockpit" element={<Navigate to="/dashboard#smart" replace />} /><Route path="/smart-hub" element={<Navigate to="/dashboard#smart" replace />} />
