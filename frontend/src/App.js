...
function App() {
  ...
  return <BrowserRouter><AuthProvider><ErrorBoundary><Toaster position="top-right" richColors /><ChurvoxHelpWidget /><Routes>
    ...
    <Route path="/onboarding" element={<BusinessRoute><OnboardingCommandPage /></BusinessRoute>} /><Route path="/jobs-board" element={<BusinessRoute><CommandDeskRoute /></BusinessRoute>} /><Route path="/jobs" element={<Navigate to="/jobs-board" replace />} /><Route path="/jobs/new" element={<BusinessRoute><JobFormPage /></BusinessRoute>} /><Route path="/jobs/:id" element={<BusinessRoute><JobDetailPage /></BusinessRoute>} /><Route path="/jobs/:id/edit" element={<BusinessRoute><JobFormPage /></BusinessRoute>} />
    <Route path="/clients/:clientId/workbench" element={<BusinessRoute><ClientWorkbenchCommandPage /></BusinessRoute>} /><Route path="/clients-board" element={<BusinessRoute><CommandDeskRoute /></BusinessRoute>} /><Route path="/clients" element={<Navigate to="/clients-board" replace />} /><Route path="/clients/new" element={<BusinessRoute><ConceptCFrame area="clients"><ClientFormPage /></ConceptCFrame></BusinessRoute>} /><Route path="/clients/:id" element={<BusinessRoute><ConceptCFrame area="clients"><ClientDetailPage /></ConceptCFrame></BusinessRoute>} /><Route path="/clients/:id/edit" element={<BusinessRoute><ConceptCFrame area="clients"><ClientFormPage /></ConceptCFrame></BusinessRoute>} />
    <Route path="/quotes-board" element={<BusinessRoute><CommandDeskRoute /></BusinessRoute>} /><Route path="/quotes" element={<Navigate to="/quotes-board" replace />} /><Route path="/quotes/new" element={<BusinessRoute><ConceptCFrame area="quotes"><QuoteFormPage /></ConceptCFrame></BusinessRoute>} /><Route path="/quotes/:id" element={<BusinessRoute><ConceptCFrame area="quotes"><QuoteDetailPage /></ConceptCFrame></BusinessRoute>} /><Route path="/quotes/:id/edit" element={<BusinessRoute><ConceptCFrame area="quotes"><QuoteFormPage /></ConceptCFrame></BusinessRoute>} />
    <Route path="/invoices-board" element={<BusinessRoute><CommandDeskRoute /></BusinessRoute>} /><Route path="/invoices" element={<Navigate to="/invoices-board" replace />} /><Route path="/invoices/new" element={<BusinessRoute><ConceptCFrame area="invoices"><InvoiceFormPage /></ConceptCFrame></BusinessRoute>} /><Route path="/invoices/:id" element={<BusinessRoute><ConceptCFrame area="invoices"><InvoiceDetailPage /></ConceptCFrame></BusinessRoute>} /><Route path="/invoices/:id/edit" element={<BusinessRoute><ConceptCFrame area="invoices"><InvoiceFormPage /></ConceptCFrame></BusinessRoute>} />
    <Route path="/reports-board" element={<ReportsRoute><CommandDeskRoute /></ReportsRoute>} /><Route path="/reports" element={<Navigate to="/reports-board" replace />} /><Route path="/settings-board" element={<BusinessRoute><SettingsCommandPage /></BusinessRoute>} /><Route path="/settings" element={<Navigate to="/settings-board" replace />} /><Route path="/support-board" element={<BusinessRoute><SupportCommandPage /></BusinessRoute>} /><Route path="/support" element={<Navigate to="/support-board" replace />} />
    ...
    <Route path="/team-board" element={<PlanTierRoute requiredPlan="team" feature="Team workspace"><CommandDeskRoute /></PlanTierRoute>} /><Route path="/team" element={<Navigate to="/team-board" replace />} /><Route path="/payroll-board" element={<PlanTierRoute requiredPlan="enterprise" feature="Payroll workspace"><CommandDeskRoute /></PlanTierRoute>} /><Route path="/payroll" element={<Navigate to="/payroll-board" replace />} />
