...
function ReportsRoute({ children }) { const { user, loading, normalizedRole } = useAuth(); if (loading) return <Spinner />; if (!user) return <Navigate to="/login" replace />; if (!["owner", "manager", "office_admin"].includes(normalizedRole)) return <Navigate to={getDefaultRoute(normalizedRole)} replace />; return <AppPage>{children}</AppPage>; }
...
function App() {
  ...
  return <BrowserRouter><AuthProvider><ErrorBoundary><Toaster position="top-right" richColors /><FloatingBottomNav /><Routes>
    ...
    <Route path="/ai-operator" element={<BusinessRoute><ErrorBoundary fallbackHref="/dashboard" fallbackLabel="Back to Command Board"><CommandDeskOperatorPage /></ErrorBoundary></BusinessRoute>} /><Route path="/ai-operator/approvals" element={<BusinessRoute><ErrorBoundary fallbackHref="/dashboard" fallbackLabel="Back to Command Board"><CommandDeskOperatorPage /></ErrorBoundary></BusinessRoute>} />
    ...
    <Route path="/dashboard" element={<BusinessRoute><ErrorBoundary fallbackHref="/login" fallbackLabel="Back to login"><CommandDeskOperatorPage /></ErrorBoundary></BusinessRoute>} /><Route path="/overview" element={<Navigate to="/dashboard" replace />} />
    ...
    <Route path="/invoices-board" element={<BusinessRoute><InvoicesCommandPage /></BusinessRoute>} /><Route path="/invoices" element={<Navigate to="/invoices-board" replace />} /><Route path="/invoices/new" element={<BusinessRoute><ConceptCFrame area="invoices"><InvoiceFormPage /></ConceptCFrame></BusinessRoute>} /><Route path="/invoices/:id" element={<BusinessRoute><ConceptCFrame area="invoices"><InvoiceDetailPage /></ConceptCFrame></BusinessRoute>} />
    <Route path="/reports-board" element={<ReportsRoute><ReportsCommandPage /></ReportsRoute>} /><Route path="/reports" element={<Navigate to="/reports-board" replace />} /><Route path="/settings-board" element={<BusinessRoute><SettingsCommandPage /></BusinessRoute>} /><Route path="/settings" element={<Navigate to="/settings-board" replace />} /><Route path="/support-board" element={<PrivateRoute><SupportCommandPage /></PrivateRoute>} /><Route path="/support" element={<Navigate to="/support-board" replace />} />
    <Route path="/plans" element={<OwnerRoute><PlansCommandPage /></OwnerRoute>} /><Route path="/billing" element={<OwnerRoute><BillingReturnPage /></OwnerRoute>} /><Route path="/billing/success" element={<OwnerRoute><BillingReturnPage /></OwnerRoute>} /><Route path="/billing/cancel" element={<OwnerRoute><BillingReturnPage cancelled /></OwnerRoute>} />
    <Route path="/team-board" element={<PlanTierRoute requiredPlan="team" feature="Team workspace"><TeamCommandPage /></PlanTierRoute>} /><Route path="/team" element={<Navigate to="/team-board" replace />} /><Route path="/payroll-board" element={<PlanTierRoute requiredPlan="enterprise" feature="Payroll workspace"><PayrollCommandPage /></PlanTierRoute>} /><Route path="/payroll" element={<Navigate to="/payroll-board" replace />} />
