...
const EXACT_REPLACEMENTS = [
  ...
  ['live scan', 'business check'],
  ['Live office check', 'Business check'],
  ['live office check', 'business check'],
  ['Live read-only records', 'Current records'],
  ['live read-only records', 'current records'],
  ['Live refresh', 'Current-record refresh'],
  ['live refresh', 'current-record refresh'],
  ['confirmed live Command slip', 'confirmed Command decision'],
  ['confirmed live command slip', 'confirmed Command decision'],
  ['control preview', 'workspace'],
  ['browser-only decisions', 'unconfirmed decisions'],
  ['live data source', 'business record source'],
