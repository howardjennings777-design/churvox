...
export const PLAN_TIERS = Object.freeze([
  {
    ...
    locked: [
      ...
      "Command, prepared admin and payroll review",
  ...
  },
  {
    ...
    locked: [
      ...
      "Payroll review, Approval Memory and deeper owner analysis",
      "Accounting Sync — available as a $39 add-on",
    ],
  },
  {
    ...
    included: [
      ...
      "Owner approval before anything sends or changes",
    ],
    locked: [
      "Payroll review and timesheets workspace",
  ...
  },
  {
    ...
    price: 299,
    badge: "Full control",
    step: "Add payroll, accounting, control and scale",
    headline: "Full Churvox control for a larger operation.",
    bestFor: "Best for a larger business that needs payroll review, accounting sync, deeper controls and more operating capacity.",
    ...
    included: [
      ...
      "What Happens If? business simulations",
      "Control Score, advanced imports, exports and Growth Pack access",
    ],
    locked: [],
