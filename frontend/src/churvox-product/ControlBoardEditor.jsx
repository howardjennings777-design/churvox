...
function fieldsFor(record, data) {
  ...
  if (record.type === "message") return [field("From", "from"), field("To", "to"), field("Channel", "channel", "select", OPTIONS.channel), field("Client", "client", "select", clients), field("Job", "job"), field("Subject", "subject"), field("Priority", "priority", "select", OPTIONS.priority), field("Message", "detail", "textarea", null, true), field("Prepared reply", "draft", "textarea", null, true)];
