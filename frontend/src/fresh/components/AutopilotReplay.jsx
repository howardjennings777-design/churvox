...
export default function AutopilotReplay({ jobs = [], invoices = [], team = [], drafts = [], approvals = [] }) {
  ...
  }, [jobs, invoices, team, drafts, approvals, tick]);
