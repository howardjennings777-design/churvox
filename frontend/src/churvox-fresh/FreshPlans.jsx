...
const plans = [
  { id: "start", backendPlan: "solo", name: "Start", price: 39, tag: "Solo", headline: "Get the work under control", summary: "For one owner who wants jobs, clients, quotes and invoices in one place.", limit: "250 clients · 50 jobs/month · 1 owner + 1 helper", includes: ["Core jobs, clients, quotes and invoices", "Smart Hub + basic Command desk", "250 clients", "50 jobs/month", "1 owner + 1 helper", "25 AI Operator Actions/month", "Accounting Sync Add-on available"], addOns: [accountingAddonText] },
  { id: "crew", backendPlan: "team", name: "Crew", price: 89, tag: "Team", headline: "Run the crew", summary: "For a small team that needs worker proof, time approval and cleaner handover.", limit: "1,000 clients · 150 jobs/month · 5 active team members", includes: ["Everything in Start", "1,000 clients", "150 jobs/month", "5 active team members", "100 AI Operator Actions/month", "Worker Proof Pack", "Worker Time Approval", "Accounting Sync Add-on available"], addOns: [accountingAddonText] },
  { id: "operator", backendPlan: "pro", name: "Operator", price: 149, tag: "Recommended", headline: "Churvox prepares the admin", summary: "For owners who want Churvox to prepare admin, follow-ups and approval work.", limit: "3,000 clients · 500 jobs/month · 15 active team members", includes: ["Everything in Crew", "3,000 clients", "500 jobs/month", "15 active team members", "500 AI Operator Actions/month", "Admin recovery batch up to 25", "Customer Follow-Up Brain", "Accounting Sync Add-on available"], addOns: [accountingAddonText] },
  { id: "command", backendPlan: "enterprise", name: "Command", price: 299, tag: "Scale", headline: "Full control at scale", summary: "For the bigger business that wants AI approval control, payroll workspace and accounting sync included.", limit: "10,000 clients · 1,500 jobs/month · 50 active team members", includes: ["Everything in Operator", "10,000 clients", "1,500 jobs/month", "50 active team members", "2,000 AI Operator Actions/month", "One accounting sync included — Xero or MYOB", "Payroll workspace", "Imports, reports and exports", "Command Growth Pack available"], addOns: ["Command Growth Pack — $99/month + GST"] },
];
...
export default function FreshPlans({ onNavigate }) {
  ...
  const planComparison = [["Start", "1 owner + 1 helper", "250 clients, 50 jobs/month, 25 AI actions."], ["Crew", "5 active team members", "1,000 clients, 150 jobs/month, worker proof and time approval."], ["Operator", "15 active team members", "3,000 clients, 500 jobs/month, 500 AI actions. AI prepares admin. You approve."], ["Command", "50 active team members", "10,000 clients, 1,500 jobs/month, 2,000 AI actions, accounting sync included."]];
