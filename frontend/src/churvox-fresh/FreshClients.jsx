  ...
  return (
    <section>
      <header className="freshHero">
        ...
        <p>Contact, service address, billing details, site notes and next client action.</p>
      </header>

      <section className="freshGrid">
        <aside className="freshCard">
          <h2>Find client</h2>
          {clients.map(([name, detail, status], index) => (
            <div className={`freshItem ${status.includes("Needs") ? "need" : ""} ${index === 0 ? "active" : ""}`} key={name}>
              <b>{name}</b>
        ...
        <section className="freshCard">
          ...
          <label className="freshField">
            ...
            <input value="Aroha Property Care" readOnly />
          </label>
          <label className="freshField">
            <span>Email</span>
            <input value="office@arohaproperty.co.nz" readOnly />
          </label>
          <label className="freshField">
            <span>Service address</span>
            <input value="42 Rata Street, Naenae" readOnly />
          </label>
          <label className="freshField">
            <span>Billing email</span>
            <input value="accounts@arohaproperty.co.nz" readOnly />
          </label>
        </section>
