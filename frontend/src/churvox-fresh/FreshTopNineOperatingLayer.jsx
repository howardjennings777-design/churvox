...
function makeSupportSlip(runAction) {
  try {
    ...
    const slip = {
      ...
      info: "Owner wants help or a setup review",
      urgency: "Setup check",
      found: "Owner asked for help from Business Health.",
      prepared: "Churvox prepared a support/setup request.",
      why: "Clear setup help keeps owners moving and stops them getting stuck.",
      owner: "Add any details, then send it through support or keep it in Command.",
      area: "Help",
      page: "helpdesk",
      fromInbox: true,
  ...
  return [
    {
      id: "today",
      title: "Today’s work",
      promise: "See jobs, late work, approvals, and money waiting without hunting through pages.",
      metric: `${urgent || commandWaiting} waiting`,
      status: urgent ? "Needs owner attention" : "Calm right now",
      action: "Refresh",
      onClick: () => runAction?.("refresh"),
      tone: urgent ? "need" : "ok",
      why: "Owners want the app to tell them what matters today.",
    },
    {
      id: "worker-proof",
      title: "Worker proof",
      promise: "Check time, notes, and proof before invoicing or approving completed work.",
      ...
      why: "Photos, notes, and time logs help prevent disputes and missed details.",
    },
    {
      id: "invoice-ready",
    ...
    },
    {
      ...
      why: "Owners fall behind when small admin jobs sit untouched for days.",
    },
    {
      id: "support",
      title: "Setup help",
      promise: "Ask for help before setup confusion turns into frustration.",
      metric: "Help ready",
