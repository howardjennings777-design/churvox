...
export const FEATURE_RULES = {
  ...
  golive: { area: "Go Live & Trust", open: "start", reason: "Every business gets onboarding, recovery, portability, security and evidence controls." },
  imports: { area: "Ten-minute onboarding and imports", open: "start", reason: "Every business must be able to bring existing records in safely." },
  exports: { area: "Exports", open: "start", reason: "Business data ownership cannot be paywalled." },
  portal: { area: "Customer portal", open: "start", reason: "Every plan can share an owner-approved customer link." },
  permissions: { area: "Permissions and security", open: "start", reason: "Basic security and owner controls stay open." },
  recovery: { area: "Recovery and undo", open: "start", reason: "Owners must be able to understand and reverse safe internal actions." },
  portability: { area: "Business Portability Pack", open: "start", reason: "The business belongs to the owner." },
  evidence: { area: "Evidence Drawer", open: "start", reason: "Churvox must explain record-backed findings on every plan." },
  offlinesync: { area: "Offline Worker Sync", open: "crew", reason: "Crew adds assigned worker access and safe offline field updates." },
  custompermissions: { area: "Custom permission overrides", open: "operator", reason: "Operator adds custom role policies beyond the safe presets." },
