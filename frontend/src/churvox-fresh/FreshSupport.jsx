...
export default function FreshSupport({ onNavigate }) {
  ...
  return <section data-support-clean-routes="20260626">
    ...
    <section className="freshGrid two" style={{ marginTop: 14 }}><section className="freshCard"><h2>Owner-controlled limits</h2><div className="freshItem need"><b>Accounting sync</b><span>Draft/review focused, with the owner controlling the handoff.</span></div><div className="freshItem need"><b>Payroll</b><span>Review and export workspace for owner checking.</span></div><div className="freshItem"><b>Support trail</b><span>Support issues can be emailed and copied into Command.</span></div></section><aside className="freshCard"><h2>Useful owner shortcuts</h2><div className="freshActions"><button type="button" className="freshPrimary" onClick={() => onNavigate?.("smart")}>Today</button><button type="button" className="freshGhost" onClick={() => onNavigate?.("imports")}>Imports</button><button type="button" className="freshGhost" onClick={() => onNavigate?.("xero")}>Xero</button><button type="button" className="freshGhost" onClick={() => onNavigate?.("payroll")}>Payroll</button><button type="button" className="freshGhost" onClick={() => onNavigate?.("plans")}>Plans</button><button type="button" className="freshGhost" onClick={() => onNavigate?.("trust")}>Trust</button></div></aside></section>
  </section>;
}
