...
function isInsideDarkPanel(el) {
  return Boolean(el.closest(
    ".freshDark, .freshHero, .freshShellSidebar, .freshAskHero, .tellHero, .freshTellLauncherHero, .freshCommandHero, .freshWorkerAppHero, .freshAIHubHero, .freshWorkerAppSummary, .fresh, .freshCommandBox, [class*='Hero'], [class*='Dark'], [class*='dark']"
  ));
}
