...
const configs = {
  ...
  clients: { endpoint: "/clients", kicker: "Clients", title: "Clients, jobs and history together.", subtitle: "Keep customer details, addresses and job history in one simple command view.", create: "/clients/new", createLabel: "Add client", detail: (x) => `/clients/${idOf(x)}`, samples: [{ name: "Green Street Rentals", email: "hello@churvox.com", status: "ready" }] },
