...
export default function PremiumAIBox({
  ...
  chip = 'Approval-first',
  suggestions = [],
  notice = 'Approval-first: review every prepared action before anything is sent or changed. Customer messages are logged and controlled by approval settings.',
  children,
  actions,
  className = '',
