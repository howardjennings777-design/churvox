  ...
  return (
    <section className={compact ? "" : "px-card"}>
      <div className="px-card__body space-y-4">
        ...
        <p className="text-xs text-[#5b6c87] flex items-center gap-1.5"><ShieldCheck className="h-3.5 w-3.5" /> {safetyNote || "Approval-only mode is ON. AI prepared this for review. No auto-charge, payroll changes, or MYOB writes without owner approval."}</p>
      </div>
    </section>
  );
}
