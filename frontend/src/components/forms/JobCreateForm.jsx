  ...
  return <form onSubmit={handleSubmit} className="min-h-full flex flex-col" data-version="CHURVOX_CLEAN_JOB_FORM_20260619">
    <div className="space-y-4 pb-28">
      <section className={section}>
        ...
        <div><Label htmlFor="job-title">Job title</Label><Input id="job-title" className="w-full rounded-xl" value={form.title} onChange={(e)=>setForm((p)=>({...p,title:e.target.value}))} data-testid="job-title-input" /></div>
