...
export default function PageState({
  ...
  return (
    <div className={`min-h-[42vh] w-full flex items-center justify-center px-4 py-10 ${className}`}>
      <div className="w-full max-w-md rounded-2xl border border-border bg-white p-6 text-center shadow-[0_8px_20px_rgba(15,23,42,0.08)]">
        {isLoading && (
        ...
        {isEmpty && (
          <div className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-blue-50 text-xl text-blue-600">
            •
          </div>
        )}
