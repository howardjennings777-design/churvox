...
export function ChurvoxLogo({ size = "md", markOnly = false, compact = false, dark = false, dataTestId }) {
  ...
  const titleColor = dark ? "#ffffff" : "#07111f";
  const subColor = dark ? "#38bdf8" : "#1769ff";
    ...
    <div data-testid={dataTestId} style={{ display: "inline-flex", alignItems: "center", gap: compact ? 0 : 12 }}>
      <svg width={scale} height={scale} viewBox="0 0 72 72" fill="none" aria-hidden="true">
        ...
        <path
          ...
          fill="url(#cvxSignal)"
        />
        <path d="M23 25.5H32.5" stroke="#EAF7FF" strokeWidth="4" strokeLinecap="round" opacity="0.94" />
        <path d="M21 34.7H31" stroke="#EAF7FF" strokeWidth="4" strokeLinecap="round" opacity="0.88" />
        <path d="M46.5 24.5C50.2 26.3 52.8 30.1 52.8 34.5" stroke="#38BDF8" strokeWidth="3" strokeLinecap="round" opacity="0.88" />
        <path d="M43.9 29.7C45.6 30.7 46.8 32.5 46.8 34.6" stroke="#8BD450" strokeWidth="3" strokeLinecap="round" opacity="0.92" />
      </svg>
