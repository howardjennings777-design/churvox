...
function Style() {
  return <style>{`
    ...
    .cxSlip{width:100%;background:#f6f1e7;border-radius:34px;overflow:hidden;display:grid;grid-template-rows:auto 1fr}
    ...
    .cxSlip main{min-height:0;display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr) 340px;gap:16px;padding:16px;overflow:auto}
    .cxPanel,.cxControls{background:#fffdf7;border:1px solid rgba(15,23,42,.12);border-radius:26px;padding:18px;box-shadow:0 14px 38px rgba(15,23,42,.1)}
    .cxPanel h2,.cxControls h2{font-size:32px;line-height:.95;margin:0 0 14px}
    .cxDark{background:#111827;color:white;border-left:6px solid #f97316;border-radius:18px;padding:14px;margin-bottom:10px}
    .cxDark b{display:block;color:#fbbf24;text-transform:uppercase;font-size:11px;letter-spacing:.14em}
    .cxDark p{font-weight:900}
    .cxFacts{display:grid;gap:10px}
    .cxFacts div{background:#f8f3ea;border-radius:16px;padding:12px}
    ...
    .cxFacts span,.cxControls p{font-weight:850}
    .cxFields{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}
    .cxField.wide{grid-column:1/-1}
    .cxField input,.cxField textarea{width:100%;border:1px solid rgba(15,23,42,.18);border-radius:16px;padding:12px 14px;font-weight:900}
    ...
    .cxOk{background:#dcfce7;color:#065f46;border-radius:16px;padding:12px 14px;font-weight:1000}
