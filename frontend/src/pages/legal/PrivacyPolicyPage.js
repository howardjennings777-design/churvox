      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-5 space-y-6 text-sm leading-7 text-slate-500">
          ...
          <div className="border-t border-slate-200 pt-6">
            <h2 className="text-slate-900 text-xl font-semibold mb-3">Information We Collect</h2>
            <p>
          ...
          <div className="border-t border-slate-200 pt-6">
            <h2 className="text-slate-900 text-xl font-semibold mb-3">How We Use Your Information</h2>
            <p>
          ...
          <div className="border-t border-slate-200 pt-6">
            <h2 className="text-slate-900 text-xl font-semibold mb-3">Data Sharing</h2>
            <p>
          ...
          <div className="border-t border-slate-200 pt-6">
            <h2 className="text-slate-900 text-xl font-semibold mb-3">Data Security</h2>
            <p>
          ...
          <div className="border-t border-slate-200 pt-6">
            <h2 className="text-slate-900 text-xl font-semibold mb-3">Data Retention</h2>
            <p>
          ...
          <div className="border-t border-slate-200 pt-6">
            <h2 className="text-slate-900 text-xl font-semibold mb-3">Your Choices</h2>
            <p>
