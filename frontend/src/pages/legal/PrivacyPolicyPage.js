      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="space-y-4 text-sm text-churvox-muted leading-7">
          <section>
            ...
            <p>
              We may collect account details, business information, customer details, job records,
              invoices, quotes, team member information, and usage data needed to run the app.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              We use your information to provide job management features, improve reliability,
              support your account, process subscriptions, and maintain security.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              needed for hosting, payments, notifications, analytics, and support.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You can update your account information inside the app. You can also request account deletion,
              which removes your account and associated business data subject to legal and operational requirements.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              For privacy questions, contact: hello@churvox.com
            </p>
          </section>
        </div>
      </div>
