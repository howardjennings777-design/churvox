      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="rounded-2xl border border-churvox-border bg-churvox-card p-5 space-y-6 text-sm leading-7 text-churvox-muted">
          ...
          <div className="border-t border-churvox-border pt-6">
            <h2 className="text-white text-xl font-semibold mb-3">Use of the Service</h2>
            <p>
          ...
          <div className="border-t border-churvox-border pt-6">
            <h2 className="text-white text-xl font-semibold mb-3">Accounts</h2>
            <p>
          ...
          <div className="border-t border-churvox-border pt-6">
            <h2 className="text-white text-xl font-semibold mb-3">Plans, Billing, and Trials</h2>
            <p>
          ...
          <div className="border-t border-churvox-border pt-6">
            <h2 className="text-white text-xl font-semibold mb-3">Data and Content</h2>
            <p>
          ...
          <div className="border-t border-churvox-border pt-6">
            <h2 className="text-white text-xl font-semibold mb-3">Availability</h2>
            <p>
          ...
          <div className="border-t border-churvox-border pt-6">
            <h2 className="text-white text-xl font-semibold mb-3">Termination</h2>
            <p>
