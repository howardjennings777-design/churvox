        ...
        <div className="prose prose-invert max-w-none space-y-6" data-testid="privacy-content">
          <div className="bg-churvox-card border border-churvox-border rounded-xl p-6 md:p-8 space-y-6">
            <p className="text-churvox-muted text-sm leading-relaxed">
              Churvox Privacy Policy placeholder text will be added here.
            </p>
            <div className="border-t border-churvox-border pt-6 space-y-4">
              <h2 className="text-lg font-semibold text-white">Information We Collect</h2>
              <p className="text-churvox-muted text-sm leading-relaxed">Details about the information we collect will be added here.</p>
            </div>
            <div className="border-t border-churvox-border pt-6 space-y-4">
              <h2 className="text-lg font-semibold text-white">How We Use Your Information</h2>
              <p className="text-churvox-muted text-sm leading-relaxed">Details about how we use your information will be added here.</p>
            </div>
            <div className="border-t border-churvox-border pt-6 space-y-4">
              <h2 className="text-lg font-semibold text-white">Data Security</h2>
              <p className="text-churvox-muted text-sm leading-relaxed">Details about data security practices will be added here.</p>
            </div>
            <div className="border-t border-churvox-border pt-6 space-y-4">
              <h2 className="text-lg font-semibold text-white">Contact Us</h2>
              <p className="text-churvox-muted text-sm leading-relaxed">If you have questions about this Privacy Policy, please contact us.</p>
            </div>
          </div>
        </div>
