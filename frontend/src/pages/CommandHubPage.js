...
const WORKSPACES = [
  ["Jobs", ROUTES.jobs], ["Clients", ROUTES.clients], ["Quotes", ROUTES.quotes], ["Invoices", ROUTES.invoices], ["Team", ROUTES.team], ["Assign crew", ROUTES.dispatch], ["Proof-to-Paid", ROUTES.proof], ["Account & Plan", ROUTES.account], ["Settings", ROUTES.settings]
];
...
export default function CommandHubPage() {
  ...
  const sectionTiles = [["Approvals", "approvals", actions.length], ["Assign crew", "dispatch", groups.dispatch.length], ["Revenue", "revenue", groups.revenue.length], ["Proof-to-Paid", "proof", groups.proof.length], ["Follow-Ups", "follow", groups.follow.length]];
