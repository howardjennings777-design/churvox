  ...
  return (
    <main className={industrialPageShell} data-command-canvas>
      <section className={`${industrialContentLane} space-y-5`}>
        <section className="rounded-[34px] border-l-8 border-orange-500 bg-slate-950 p-8 text-white shadow-2xl">
          <span className={industrialChip}>Support</span>
          <h1 className="mt-5 text-5xl font-black leading-[.9] tracking-[-.08em] md:text-7xl">Email support only.</h1>
          <p className="mt-5 max-w-3xl text-base font-bold leading-7 text-slate-300">Type the issue here and send it to Churvox support from this page.</p>
        ...
        <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
          <section className="rounded-[30px] border border-slate-200 bg-white p-6 shadow-[0_18px_50px_rgba(15,23,42,.07)]">
            ...
            <h2 className="mt-2 text-3xl font-black tracking-[-.06em]">Send support message</h2>
