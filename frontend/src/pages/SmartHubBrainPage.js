      ...
      <div className="min-h-screen bg-[#d8d2c6] text-[#0f1115] tradie-page-bg" style={{ backgroundImage: "linear-gradient(135deg, rgba(15,17,21,0.04) 25%, transparent 25%), linear-gradient(225deg, rgba(15,17,21,0.04) 25%, transparent 25%)", backgroundColor: "#d8d2c6", backgroundSize: "28px 28px" }}>
        <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
          <section
            ...
            style={{ background: "linear-gradient(135deg, #0d0f12 0%, #15181d 45%, #2a2f36 100%)", borderColor: "rgba(255,255,255,0.14)" }}
          >
            <p className="text-xs uppercase tracking-[0.2em] text-[#fdba74]">AI Operator Control Centre</p>
            <span className="mt-2 inline-flex rounded-full border border-[#fdba74] bg-[#f97316] px-2 py-1 text-[10px] font-bold uppercase tracking-[0.18em] text-white">HARD TRADE THEME v3</span>
          ...
          <section className="mt-6 rounded-3xl border border-[#9f978a] bg-[#ede8df] p-4 shadow-sm">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <button type="button" onClick={() => openWorkspace("Payment Reminders", "reminders")} className="rounded-lg bg-[#f97316] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#ea580c]">Prepare reminders</button>
              <button type="button" onClick={() => openWorkspace("Quote Follow-ups", "followUps")} className="rounded-lg bg-[#f97316] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#ea580c]">Review follow-ups</button>
              <button type="button" onClick={() => openWorkspace("AI Dispatch", "assign")} className="rounded-lg bg-[#f97316] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#ea580c]">Assign workers</button>
            </div>
          </section>
