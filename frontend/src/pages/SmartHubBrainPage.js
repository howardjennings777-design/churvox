...
export default function SmartHubBrainPage() {
        ...
        <div className="space-y-4">
          ...
          {!readyToBillJobs.length ? (
            ...
            readyToBillJobs.map((job) => {
              ...
              return (
                <div key={String(job?.id || job?._id || job?.job_id || Math.random())} className="rounded-2xl border border-[#2a2f36] bg-[#111317] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.3)] transition hover:border-[#f97316] operator-panel operator-card" data-smart-hub-card="true">
  ...
  return (
    <Layout title="Smart Hub">
      <div className="min-h-screen bg-[#b8afa1] text-[#0f1115] tradie-page-bg smart-hub-hard-trade-v4" style={{ background: "linear-gradient(180deg, #b8afa1 0%, #a99f91 100%)" }}>
        <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-8">
          ...
          <section className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
            {[
              ...
              <article key={label} className="rounded-2xl border border-[#2a2f36] bg-[#111317] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.3)] transition hover:border-[#f97316] operator-panel operator-card" data-smart-hub-card="true">
                <p className="text-xs uppercase tracking-wide text-white/55">{label}</p>
          ...
          <section className="mt-6 rounded-2xl border border-[#746c60] border-l-4 border-l-[#f97316] bg-[#c8bfb1] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.18)]">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <button type="button" onClick={() => { openApprovalCentre({ tab: "all" }); }} className="rounded-xl bg-[#f97316] px-3 py-2 text-sm font-semibold text-white">Open Approval Centre</button>
          ...
          <section className="mt-6 grid gap-4 lg:grid-cols-2">
            <article className="rounded-2xl border border-[#746c60] bg-[#c8bfb1] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.18)] border-l-4 border-l-[#f97316] operator-hero" data-smart-hub-hero="true">
            ...
            <article className="rounded-2xl border border-[#746c60] bg-[#c8bfb1] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.18)] border-l-4 border-l-[#f97316] operator-panel operator-card operator-accent-left" data-smart-hub-card="true">
          ...
          <section className="mt-6 rounded-2xl border border-[#746c60] bg-[#c8bfb1] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.18)] operator-panel operator-card" data-smart-hub-card="true">
          ...
          <section className="mt-4 rounded-2xl border border-[#746c60] bg-[#c8bfb1] p-4 shadow-[0_10px_24px_rgba(15,17,21,0.18)]">
