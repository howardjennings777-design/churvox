...
export default function SmartHubBrainPage() {
  ...
  const handleReviewAction = (action) => { setSelectedAction(action || null); setSelectedSmartHubAction(action || null); setReviewMode("list"); setActionError(""); setIsActionModalOpen(true); };
