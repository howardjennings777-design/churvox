      ...
      <main className="home-page">
        <section className="home-hero">
          <div className="home-hero-copy">
            ...
            <div className="home-actions"><CTA to="/signup" primary>Start free</CTA><CTA to="/pricing">See pricing</CTA></div>
          </div>
          <ConsolePreview />
        </section>
