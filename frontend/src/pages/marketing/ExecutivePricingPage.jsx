...
const plans=[
  ...
  {name:"Crew",price:"$89",tag:"Small team",summary:"For a growing crew that needs field work, clients and money in one place.",features:["Everything in Start","Team and worker workflow","Live crew visibility","Job proof and notes","More jobs and client capacity"]},
  {name:"Operator",price:"$149",tag:"Most popular",summary:"For owners who want Churvox to prepare the admin so they only approve what matters.",features:["Everything in Crew","AI Operator Actions","Draft invoice and quote follow-ups","Urgent action queue","MYOB add-on available"]},
