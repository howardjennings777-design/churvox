...
const [workers, setWorkers] = useState([]);
  ...
  <span className="ml-2 inline-flex items-center rounded-full border border-slate-600 bg-slate-800/80 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-slate-300">
    Coming Soon
...
</span> · Coming Soon <span className="text-slate-500 text-sm font-medium ml-2">Coming Soon</span></span>
              </div>
              ...
              <p className="text-[10px] text-churvox-muted mt-2">SMS feature coming soon.</p>
            </CardContent>
          </Card>
        )}
