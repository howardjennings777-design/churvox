...
const panelDefs = {
  ...
  crew: ["Assign crew / assign worker", "/dispatch?embedded=1", "crew", "Assign unassigned jobs to the right worker."],
...
const shortcuts = [
  ...
  ["Assign crew", "Assign jobs and plan the day", "/dispatch?embedded=1", "crew"],
