...
export default function SMSPage() {
  ...
  return <Layout><div className="cx-page space-y-4">
    ...
    <div className="rounded-2xl border border-slate-200 bg-white p-4"><p className="font-black text-slate-950">Credit packs</p><ul className="text-slate-800 text-sm list-disc pl-4"><li>100 credits / $10</li><li>500 credits / $45</li><li>1000 credits / $80</li></ul></div>
