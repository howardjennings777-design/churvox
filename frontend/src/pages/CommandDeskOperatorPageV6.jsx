...
@media (min-width:1024px){.cxRoot{padding:24px 24px 130px}.cxStats{grid-template-columns:repeat(4,minmax(0,1fr))}.cxBoxes{grid-template-columns:repeat(3,minmax(0,1fr));gap:20px}.cxQueueRows{grid-template-columns:repeat(4,minmax(0,1fr))}.cxSlip main{grid-template-columns:minmax(0,1fr)330px}.cxControls{position:sticky;top:0;align-self:start}.cxOverlay{padding:18px}.cxHero,.cxQueue{border-radius:34px;padding:22px 26px}.cxBox{border-radius:28px;padding:20px;min-height:198px}.cxUrgent{border-radius:28px;padding:20px 24px}}
