    ...
    def include_router_with_real_ai(self, router, *args, **kwargs):
        ...
        try:
            ...
            for frame_info in inspect.stack():
                ...
                try:
                    from churvox_signature_command_create_routes import build_signature_command_create_router
                except Exception:
                    from backend.churvox_signature_command_create_routes import build_signature_command_create_router
                try:
                ...
                # Signature slips keep their Command tray, but approved drafts are routed into internal review collections.
                original_include_router(self, build_signature_command_create_router(local_db, local_get_current_user, ObjectId), prefix="/api")
