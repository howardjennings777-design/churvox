...
Generated: 2026-05-16 20:30:36 UTC
...
**Where:** `backend/server.py:19276`

**Detail:** Also defined at line 16270. Last registration may shadow earlier handler.
...
**Where:** `backend/server.py:19169`

**Detail:** Also defined at line 19030. Last registration may shadow earlier handler.

### 8. [HIGH] Backend routes — Duplicate backend route POST /ai/owner-command/approve

**Where:** `backend/server.py:14998`

**Detail:** Also defined at line 1829. Last registration may shadow earlier handler.

### 9. [HIGH] Backend routes — Duplicate backend route POST /ai/owner-command/dispatch/approve

**Where:** `backend/server.py:15204`

**Detail:** Also defined at line 1787. Last registration may shadow earlier handler.

### 10. [HIGH] Backend routes — Duplicate backend route POST /ai/owner-command/invoice/approve

**Where:** `backend/server.py:15364`

**Detail:** Also defined at line 1808. Last registration may shadow earlier handler.

### 11. [HIGH] Backend routes — Duplicate backend route POST /automation/rules

**Where:** `backend/server.py:12004`

**Detail:** Also defined at line 10504. Last registration may shadow earlier handler.

### 12. [HIGH] Backend routes — Duplicate backend route POST /billing/webhook

**Where:** `backend/server.py:10109`

**Detail:** Also defined at line 10047. Last registration may shadow earlier handler.

### 13. [HIGH] Backend routes — Duplicate backend route POST /clients/import-csv

**Where:** `backend/server.py:14666`

**Detail:** Also defined at line 9647. Last registration may shadow earlier handler.

### 14. [HIGH] Backend routes — Duplicate backend route POST /team/import-csv

**Where:** `backend/server.py:14737`

**Detail:** Also defined at line 9425. Last registration may shadow earlier handler.

### 15. [HIGH] Backend routes — Duplicate backend route POST /worker/contact-office

**Where:** `backend/server.py:14601`

**Detail:** Also defined at line 10352. Last registration may shadow earlier handler.

### 16. [HIGH] Backend routes — Duplicate backend route PUT /automation/rules/{rule_id}
...
### 40. [MED] Brand — Old Grassley brand text
...
### 50. [LOW] Brand/Deploy — Backend URL still uses grassley-backend

**Where:** `test_result.md:153`

**Detail:** Found `grassley-backend`

### 51. [LOW] Brand/Deploy — Backend URL still uses grassley-backend
...
### 68. [LOW] Code cleanup — FIXME marker remains

**Where:** `scripts/churvox_deep_audit.py:234`

**Detail:** Found `FIXME`

### 69. [LOW] Code cleanup — TODO marker remains

**Where:** `scripts/churvox_deep_audit.py:233`

**Detail:** Found `TODO`

### 70. [LOW] Launch polish — Coming Soon text still visible

**Where:** `test_churvox_validation.py:145`

**Detail:** Found `Coming Soon`

### 71. [LOW] Launch polish — Coming Soon text still visible

**Where:** `test_result.md:147`

**Detail:** Found `Coming Soon`

### 72. [LOW] Launch polish — Coming Soon text still visible

**Where:** `design_guidelines.json:130`

**Detail:** Found `Coming Soon`

### 73. [LOW] Launch polish — Coming Soon text still visible

**Where:** `backend/server.py:2142`

**Detail:** Found `Coming Soon`

### 74. [LOW] Launch polish — Coming Soon text still visible

**Where:** `test_reports/iteration_2.json:28`

**Detail:** Found `Coming Soon`

### 75. [LOW] Launch polish — Coming Soon text still visible

**Where:** `test_reports/iteration_1.json:24`

**Detail:** Found `Coming Soon`

### 76. [LOW] Launch polish — Coming Soon text still visible

**Where:** `scripts/churvox_deep_audit.py:232`

**Detail:** Found `Coming Soon`

### 77. [LOW] Launch polish — Coming Soon text still visible

**Where:** `frontend/src/pages/SMSPage.js:8`

**Detail:** Found `Coming Soon`

### 78. [LOW] Launch polish — Coming Soon text still visible

**Where:** `frontend/src/shell/ChurvoxAIShell.jsx:6194`

**Detail:** Found `Coming Soon`

### 79. [LOW] Launch polish — Coming Soon text still visible

**Where:** `backend/frontend_dist/static/js/main.ac3852af.js:2`

**Detail:** Found `Coming Soon`

### 80. [LOW] Launch polish — Lorem/sample text remains

**Where:** `churvox-visual-audit-route-check/audit.js:40`

**Detail:** Found `lorem`

### 81. [LOW] Launch polish — Lorem/sample text remains

**Where:** `scripts/churvox_deep_audit.py:236`

**Detail:** Found `lorem`

### 82. [LOW] Launch polish — Lorem/sample text remains

**Where:** `backend/scripts/cleanup_test_data.py:32`

**Detail:** Found `lorem`

### 83. [LOW] Launch polish — Placeholder wording remains

**Where:** `CHURVOX_LAUNCH_TEST_CHECKLIST.md:27`

**Detail:** Found `placeholder`

### 84. [LOW] Launch polish — Placeholder wording remains

**Where:** `CHURVOX_10_OUT_OF_10_AI_OPERATOR_ENGINE_SPEC.md:128`

**Detail:** Found `placeholder`

### 85. [LOW] Launch polish — Placeholder wording remains

**Where:** `design_guidelines.json:79`

**Detail:** Found `placeholder`

### 86. [LOW] Launch polish — Placeholder wording remains

**Where:** `frontend/package-lock.json:1967`

**Detail:** Found `placeholder`

### 87. [LOW] Launch polish — Placeholder wording remains

**Where:** `backend/sms_report.txt:2320`

**Detail:** Found `placeholder`

### 88. [LOW] Launch polish — Placeholder wording remains

**Where:** `backend/server.py:11176`

**Detail:** Found `placeholder`

### 89. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_8.json:21`

**Detail:** Found `placeholder`

### 90. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_15.json:76`

**Detail:** Found `placeholder`

### 91. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_14.json:101`

**Detail:** Found `placeholder`

### 92. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_13.json:85`

**Detail:** Found `placeholder`

### 93. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_11.json:105`

**Detail:** Found `placeholder`

### 94. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_12.json:74`

**Detail:** Found `placeholder`

### 95. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_9.json:81`

**Detail:** Found `placeholder`

### 96. [LOW] Launch polish — Placeholder wording remains

**Where:** `test_reports/iteration_10.json:56`

**Detail:** Found `placeholder`

### 97. [LOW] Launch polish — Placeholder wording remains
