...
Generated: 2026-05-16 20:42:06 UTC
...
### 17. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `backend/frontend_dist/static/js/main.ac3852af.js:2`

**Detail:** Found `alert(`

### 18. [MED] UX — Browser confirm still used instead of in-page modal
...
### 24. [LOW] Launch polish — Lorem/sample text remains
