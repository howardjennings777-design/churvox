...
Generated: 2026-05-16 20:36:09 UTC
...
**Where:** `audits/churvox_deep_audit_latest.md:57`

**Detail:** Found `Grassley`

### 9. [MED] Brand — Old Grassley brand text

**Where:** `audits/churvox_deep_audit_20260516_203445.md:57`
...
**Where:** `audits/churvox_deep_audit_20260516_203242.md:93`
...
### 31. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `backend/server.py:472`

**Detail:** Found `grassley-frontend`

### 32. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `audits/churvox_deep_audit_latest.md:223`

**Detail:** Found `grassley-frontend`

### 33. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `audits/churvox_deep_audit_20260516_203445.md:223`

**Detail:** Found `grassley-frontend`

### 34. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `audits/churvox_deep_audit_20260516_203036.md:259`

**Detail:** Found `grassley-frontend`

### 35. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `audits/churvox_deep_audit_20260516_203242.md:253`

**Detail:** Found `grassley-frontend`

### 36. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `scripts/churvox_deep_audit.py:229`

**Detail:** Found `grassley-frontend`

### 37. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `test_result.md:128`

**Detail:** Found `alert(`

### 38. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_latest.md:253`

**Detail:** Found `alert(`

### 39. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_20260516_203445.md:253`

**Detail:** Found `alert(`

### 40. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_20260516_203036.md:271`

**Detail:** Found `alert(`

### 41. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_20260516_203242.md:277`

**Detail:** Found `alert(`

### 42. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `scripts/churvox_deep_audit.py:238`

**Detail:** Found `alert(`

### 43. [MED] UX — Browser alert still used instead of in-page modal

**Where:** `backend/frontend_dist/static/js/main.ac3852af.js:2`

**Detail:** Found `alert(`

### 44. [MED] UX — Browser confirm still used instead of in-page modal

**Where:** `test_result.md:118`

**Detail:** Found `window.confirm`

### 45. [MED] UX — Browser confirm still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_latest.md:289`

**Detail:** Found `window.confirm`

### 46. [MED] UX — Browser confirm still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_20260516_203445.md:289`

**Detail:** Found `window.confirm`

### 47. [MED] UX — Browser confirm still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_20260516_203036.md:289`

**Detail:** Found `window.confirm`

### 48. [MED] UX — Browser confirm still used instead of in-page modal

**Where:** `audits/churvox_deep_audit_20260516_203242.md:307`
...
### 52. [LOW] Brand/Deploy — Backend URL still uses grassley-backend

**Where:** `test_result.md:153`

**Detail:** Found `grassley-backend`

### 53. [LOW] Brand/Deploy — Backend URL still uses grassley-backend

**Where:** `login_debug.txt:105`

**Detail:** Found `grassley-backend`

### 54. [LOW] Brand/Deploy — Backend URL still uses grassley-backend

**Where:** `backend/server.py:533`

**Detail:** Found `grassley-backend`

### 55. [LOW] Brand/Deploy — Backend URL still uses grassley-backend

**Where:** `audits/churvox_deep_audit_latest.md:327`

**Detail:** Found `grassley-backend`

### 56. [LOW] Brand/Deploy — Backend URL still uses grassley-backend

**Where:** `audits/churvox_deep_audit_20260516_203445.md:327`
...
**Where:** `audits/churvox_deep_audit_20260516_203242.md:339`
...
### 74. [LOW] Code cleanup — FIXME marker remains

**Where:** `audits/churvox_deep_audit_latest.md:453`

**Detail:** Found `FIXME`

### 75. [LOW] Code cleanup — FIXME marker remains

**Where:** `audits/churvox_deep_audit_20260516_203445.md:453`
...
**Where:** `audits/churvox_deep_audit_20260516_203242.md:459`

**Detail:** Found `FIXME`

### 78. [LOW] Code cleanup — FIXME marker remains
...
**Where:** `audits/churvox_deep_audit_latest.md:477`

**Detail:** Found `TODO`

### 80. [LOW] Code cleanup — TODO marker remains

**Where:** `audits/churvox_deep_audit_20260516_203445.md:477`

**Detail:** Found `TODO`

### 81. [LOW] Code cleanup — TODO marker remains

**Where:** `audits/churvox_deep_audit_20260516_203036.md:423`

**Detail:** Found `TODO`

### 82. [LOW] Code cleanup — TODO marker remains

**Where:** `audits/churvox_deep_audit_20260516_203242.md:477`

**Detail:** Found `TODO`

### 83. [LOW] Code cleanup — TODO marker remains
...
**Where:** `audits/churvox_deep_audit_latest.md:501`

**Detail:** Found `Coming Soon`

### 89. [LOW] Launch polish — Coming Soon text still visible

**Where:** `audits/churvox_deep_audit_20260516_203445.md:501`
...
**Where:** `audits/churvox_deep_audit_20260516_203242.md:495`
...
### 93. [LOW] Launch polish — Coming Soon text still visible

**Where:** `test_reports/iteration_1.json:24`

**Detail:** Found `Coming Soon`

### 94. [LOW] Launch polish — Coming Soon text still visible

**Where:** `scripts/churvox_deep_audit.py:232`

**Detail:** Found `Coming Soon`

### 95. [LOW] Launch polish — Coming Soon text still visible

**Where:** `frontend/src/pages/SMSPage.js:8`

**Detail:** Found `Coming Soon`

### 96. [LOW] Launch polish — Coming Soon text still visible

**Where:** `frontend/src/shell/ChurvoxAIShell.jsx:6194`

**Detail:** Found `Coming Soon`

### 97. [LOW] Launch polish — Coming Soon text still visible

**Where:** `backend/frontend_dist/static/js/main.ac3852af.js:2`

**Detail:** Found `Coming Soon`

### 98. [LOW] Launch polish — Lorem/sample text remains

**Where:** `audits/churvox_deep_audit_latest.md:579`

**Detail:** Found `lorem`

### 99. [LOW] Launch polish — Lorem/sample text remains

**Where:** `audits/churvox_deep_audit_20260516_203445.md:579`

**Detail:** Found `lorem`

### 100. [LOW] Launch polish — Lorem/sample text remains

**Where:** `audits/churvox_deep_audit_20260516_203036.md:489`

**Detail:** Found `lorem`

### 101. [LOW] Launch polish — Lorem/sample text remains

**Where:** `audits/churvox_deep_audit_20260516_203242.md:567`

**Detail:** Found `lorem`

### 102. [LOW] Launch polish — Lorem/sample text remains

**Where:** `churvox-visual-audit-route-check/audit.js:40`

**Detail:** Found `lorem`

### 103. [LOW] Launch polish — Lorem/sample text remains

**Where:** `scripts/churvox_deep_audit.py:236`

**Detail:** Found `lorem`

### 104. [LOW] Launch polish — Lorem/sample text remains
...
**Where:** `audits/churvox_deep_audit_latest.md:615`

**Detail:** Found `placeholder`

### 112. [LOW] Launch polish — Placeholder wording remains

**Where:** `audits/churvox_deep_audit_20260516_203445.md:615`
...
**Where:** `audits/churvox_deep_audit_20260516_203242.md:597`
