...
Generated: 2026-05-16 20:45:38 UTC
...
**Where:** `backend/server.py:19186`

**Detail:** Also defined at line 19047. Last registration may shadow earlier handler.

### 2. [HIGH] Backend routes — Duplicate backend route POST /billing/webhook

**Where:** `backend/server.py:10116`

**Detail:** Also defined at line 10054. Last registration may shadow earlier handler.

### 3. [MED] Brand — Old Grassley brand text

**Where:** `backend/server.py:1`
...
### 17. [MED] UX — Browser confirm still used instead of in-page modal

**Where:** `backend/frontend_dist/static/js/main.ac3852af.js:2`

**Detail:** Replace browser popup with an in-page modal/sheet.

### 18. [MED] UX — Native alert still used instead of in-page modal

**Where:** `backend/frontend_dist/static/js/main.ac3852af.js:2`

**Detail:** Replace browser popup with an in-page modal/sheet.

### 19. [LOW] Launch polish — Coming Soon text still visible

**Where:** `backend/server.py:2149`

**Detail:** Found `Coming Soon`

### 20. [LOW] Launch polish — Coming Soon text still visible
...
### 23. [LOW] Launch polish — Lorem/sample text remains

**Where:** `backend/scripts/cleanup_test_data.py:32`

**Detail:** Found `lorem`

### 24. [LOW] Launch polish — Placeholder wording remains
...
### 25. [LOW] Launch polish — Placeholder wording remains
