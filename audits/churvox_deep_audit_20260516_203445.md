...
Generated: 2026-05-16 20:34:45 UTC
...
### 1. [HIGH] Backend routes — Duplicate backend route GET /public/client-portal/{token}

**Where:** `backend/server.py:19286`

**Detail:** Also defined at line 16280. Last registration may shadow earlier handler.

### 2. [HIGH] Backend routes — Duplicate backend route GET /worker/office-contact

**Where:** `backend/server.py:14562`

**Detail:** Also defined at line 10259. Last registration may shadow earlier handler.

### 3. [HIGH] Backend routes — Duplicate backend route POST /ai-operator/run-daily-plan

**Where:** `backend/server.py:19179`

**Detail:** Also defined at line 19040. Last registration may shadow earlier handler.

### 4. [HIGH] Backend routes — Duplicate backend route POST /billing/webhook

**Where:** `backend/server.py:10109`

**Detail:** Also defined at line 10047. Last registration may shadow earlier handler.

### 5. [HIGH] Backend routes — Duplicate backend route POST /clients/import-csv

**Where:** `backend/server.py:14671`

**Detail:** Also defined at line 9647. Last registration may shadow earlier handler.

### 6. [HIGH] Backend routes — Duplicate backend route POST /team/import-csv

**Where:** `backend/server.py:14742`

**Detail:** Also defined at line 9425. Last registration may shadow earlier handler.

### 7. [HIGH] Backend routes — Duplicate backend route POST /worker/contact-office

**Where:** `backend/server.py:14606`
...
**Where:** `audits/churvox_deep_audit_latest.md:93`
...
### 37. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `audits/churvox_deep_audit_20260516_203036.md:259`

**Detail:** Found `grassley-frontend`

### 38. [MED] Brand/Deploy — Old Grassley frontend reference

**Where:** `audits/churvox_deep_audit_20260516_203242.md:253`

**Detail:** Found `grassley-frontend`

### 39. [MED] Brand/Deploy — Old Grassley frontend reference
...
**Where:** `audits/churvox_deep_audit_latest.md:277`
...
**Where:** `audits/churvox_deep_audit_latest.md:307`
...
**Where:** `audits/churvox_deep_audit_latest.md:339`
...
**Where:** `audits/churvox_deep_audit_latest.md:459`
...
**Where:** `audits/churvox_deep_audit_latest.md:495`
...
**Where:** `audits/churvox_deep_audit_latest.md:567`
...
**Where:** `audits/churvox_deep_audit_latest.md:597`
